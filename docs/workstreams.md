...
Last updated (UTC): 2026-02-26 14:27
...
| `copy-rules` | `codex/copy-rules` | Structured copy-rules layer and on-brand generation wiring across landing page, email builder, and follow-up email flows | `ready-for-merge` | 2026-02-26 14:27 | Browser spot-check generated copy tone + commit/push when approved |
